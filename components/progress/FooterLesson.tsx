...
export const FooterLesson = ({imagen, comprobation, continuar, changeContinue}: {imagen: string | null, comprobation: Function, continuar: Boolean, changeContinue: Function}) => {
